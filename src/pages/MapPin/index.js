...
const Map = ({ navigation }) => {
  return (
    ...
    <ImageBackground
        source={{uri: 'https://www.google.com/maps/d/thumbnail?mid=1_hejtzkcTndzdTprBfbB_TnCs7A&hl=in'}} style={{ width: 395, height: 800 }}>
          ...
          <View style={[style.detail, {flexDirection: "row", padding :14}]}>
            <Image source={{uri:'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSgzgr-JgnmlIoA9wYNwOwY_G01sP7UQG3n1w&usqp=CAU'}} style={{ width: 100, height: 150 , borderRadius : 20}}></Image>
            <View style={{paddingLeft: 20, paddingTop : 15}}>
              <Text style={{fontSize: 20, color: "black", flexDirection : "row"}}>Nama Purnama Hotel</Text>
              <Text style={{fontSize: 12, flexDirection : "row"}}>Jl. K.A. Bujang, Batu Penyu, ...</Text>
